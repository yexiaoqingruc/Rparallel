...
RcppExport SEXP _Rparallel_HuHuCAR_getData(SEXP nSEXP, SEXP cov_numSEXP, SEXP level_numSEXP, SEXP prSEXP, SEXP typeSEXP, SEXP betaSEXP, SEXP mu1SEXP, SEXP mu2SEXP, SEXP sigmaSEXP, SEXP omegaSEXP, SEXP pSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _Rparallel_HuHuCAR_BT_In(SEXP dataSEXP, SEXP BSEXP, SEXP omegaSEXP, SEXP pSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_Rparallel_HuHuCAR_getData", (DL_FUNC) &_Rparallel_HuHuCAR_getData, 11},
    {"_Rparallel_HuHuCAR_BT_In", (DL_FUNC) &_Rparallel_HuHuCAR_BT_In, 4},
    {NULL, NULL, 0}
};

RcppExport void R_init_Rparallel(DllInfo *dll) {
